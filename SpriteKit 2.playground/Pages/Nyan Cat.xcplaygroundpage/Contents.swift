...
//: ## The PlaygroundSupport Module
//: This is important... It brings in the **PlaygroundSupport** module which is what is going to allow use to show the live view. Make sure that you are showing the assistant editor (Command-Alt-Enter) otherwise you won't see your live view
...
//: We want this to show up in our AssistantEditor, and we use PlaygroundPage to do that, setting the liveView property of the current page to our newly created view
